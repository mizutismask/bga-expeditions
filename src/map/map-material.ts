...
const ROUTES = [
	...
	new Route(22, 103, 114, [new RouteSpace(501, 83, 133, -21)], BLUE),
	new Route(23, 103, 114, [new RouteSpace(501, 83, 133, -21)], YELLOW),
	new Route(24, 103, 114, [new RouteSpace(501, 83, 133, -21)], RED),
	...
	new Route(139, 136, 139, [new RouteSpace(838, 527, 10, 39)], BLUE),
	new Route(140, 136, 139, [new RouteSpace(838, 527, 10, 39)], YELLOW),
	new Route(141, 136, 139, [new RouteSpace(838, 527, 10, 39)], RED),
	...
	new Route(187, 150, 153, [new RouteSpace(103, 309, 5, 73)], BLUE),
	new Route(188, 150, 153, [new RouteSpace(103, 309, 5, 73)], YELLOW),
	new Route(189, 150, 153, [new RouteSpace(103, 309, 5, 73)], RED),
